...
/**
 * A BusDriver játékosok által irányított járművek, a stationA, és a stationB között közlekednek
 * <p>
 * 
 * Felelősség <br>
 * Két megálló közti fordulók számolása. Elakadás, ha túl magas a hó. Csúszás 
 * kezdeményezése. Ütközés kezelése, ütközés utáni újraindulás. Útvonal követése. 
...
public class Bus extends Vehicle {
    ...
    public void onTick() {
        ...
        if(whereAnswer == 1) {
            ...
            //Ha kereszteződésről indul, akkor tovább szeretne hajtani a busz, ehhez az útvonaltervéből elkéri a következő sávot, ahová a kereszteződésből behajthat
            ...
            if(snowLevelAnswer == 1 && Skeleton.questionMultiple("Tud -e sávot váltani?", Arrays.asList("igen", "Nem")) == 1) {
                ...
                int busStuckAnswer = Skeleton.questionMultiple("El volt -e akadva a busz?", Arrays.asList("igen", "Nem"));
                if(busStuckAnswer == 1) {
                    System.out.println("A busz sikeresen felszabadul");
                }
                
                //Ha éppen jeges úton tartózkodna a busz döntsük el, hogy elcsússzon -e
                int skidAnswer = Skeleton.questionMultiple("Megcsússzon -e a busz a jeges úton?", Arrays.asList("igen", "Nem"));
                if(skidAnswer == 1) {
                    ...
                    //Ha a buszunk megúszta a magas havat, és az elcsúszást is, tovább haladhatna, döntsünk kereszteződésbe ért -e
                    ...
                    if(intoCrossingAnswer == 1) {
                        ...
                        int stationAnswer = Skeleton.questionMultiple("Végállomásra érkeztél -e?", Arrays.asList("igen", "Nem"));
                        if(stationAnswer == 1) {

                            //Ha elérte a végállomását emiatt pontot adunk a játékosnak
                            System.out.println("A busz megérkezett a végállomásába, ezért kap pontot. Új célja ezután a másik végállomás");
                        }
                    }
                    else {
