...
public class LaneView {
	...
	public void paint(Graphics2D g) {
		...
		// Ha kiválasztott az út, akkor legyen zöld téglalap
		Vehicle selectedVehicle = mainPanel.getSelectedBus();
		if (selectedVehicle == null)
			selectedVehicle = mainPanel.getSelectedSnowplower();

		boolean isLanePartOfPath = false;
		if (selectedVehicle != null) {
			isLanePartOfPath = selectedVehicle.getPath().getLanes().contains(modelLane);
		}
		...
		} else if (kivalasztottAszfalt != null) {
